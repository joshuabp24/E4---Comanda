...
namespace Comanda
{
    class BaseDatos
    {
        ...
        {
            listamenu = new List<Menu> //No estaba escrito la clase que era la lista dentro de las flechitas
            ...
            Ensalada = new List<Ensaladas> //Estaba la clase menu la cual no corresponde a la lista de ensaladas
            {
            ...
            {
                new Paninis {Id =0 , Nombre = "Panini de pollo"}, //Estaban estas '' en vez de estas "" y  no lo reconocia como string
