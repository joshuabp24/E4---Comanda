...
namespace Comanda
{
    public partial class Form1 : Form
    {
        ...
        private void comboBoxMenu_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {//Aqui manda a llamar al menu pero no especifica a cual, por lo que el programa colapsa, tan solo se añade el ."Nombre del menu", aunque llevan un orden espefico el cual sale al ejecutar el programa
                ...
                default: listBoxSeleccion.DataSource = menus.listamenu;
                    listBoxSeleccion.DisplayMember = "Nombre";
                    listBoxSeleccion.ValueMember = "ID";
        ...
        private void AgregarMenu()
        {
            ...
            if (valor!=0)
            {                                      
                var datos = Convert.ToDouble(comboBoxCantidad.Text) * Convert.ToDouble(textBoxPrecio.Text);//En esta linea se intentaba multiplicar un dato de tipo double por uno de tipo decimal, por lo que solo habia que cambiar el tipo de dato de textboxprecio
        ...
        private void cobrar()
        {
            ...
            //Habia una llave causando un errores a todo lo de abajo
